...
<nav
		class="navbar navbar-expand-sm bg-primary navbar-light justify-content-between">
	...
	<br>
		<h1 align="center">Welcome to Retail Bank</h1>
			...
			<div style="margin: 5em 10em 2em 3em;">
				<div class="card  " style="width: 400px; background-color: #73b0f5">
					<div class="card-body">
						...
						<p class="card-text">Click the button below to create new Customer</p>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div style="margin: 4em 10em 14em 3em;">
				<div class="card" style="width:400px;height:210px; background-color: #73b0f5">
					<div class="card-body">
