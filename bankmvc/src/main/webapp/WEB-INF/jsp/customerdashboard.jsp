...
<body class="doodle">
	...
	<nav
		class="navbar navbar-expand-sm bg-primary navbar-dark justify-content-between">
		<div class="navbar-brand">Retail Bank</div>
		<div class="form-inline">
			<a class="btn btn-outline-light my-2 my-sm-0" href="/logout">Logout</a>&nbsp;&nbsp;
		</div>
	</nav>
	<center>
		<h1>Welcome to Retail Bank</h1>
	</center>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div style="margin: 9em 120em 14em 14em;">
				<div class="card   " style="width: 400px; background-color: #73b0f5">
					<div class="card-body">
						...
						<form:form action="/withdraw" method="post" modelAttribute="accountinput">
							...
							<br> <br> <input type="submit" name="View" value="Withdraw Amount" class="btn btn-secondary" />
						</form:form>
						<p id="message">${msg}</p>
					</div>
				</div>
				...
				<div class="card   " style="width: 400px; background-color: #73b0f5">
					<div class="card-body">
						...
						<form:select path="accountId" name="accountId">
							...
							<br> <br> <input type="submit" name="View" value="Transfer Amount" class="btn btn-secondary" />
						</form:form>
